...
contract ExecLoggingProposal is NetworkParameterProposal {
    ...
    constructor(string memory v1, string memory v2, bytes32[] memory v3,
        uint256 v4, uint256 v5, uint256 v6, uint256 v7, uint256 v8, address v9, address v10, string memory v11) NetworkParameterProposal(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11) public {}
